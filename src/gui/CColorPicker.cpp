...
int CColorPicker::ProcessMouse(int mx, int my, UINT mevent, CControl **mhook, CControl **khook)
{
	if (INBOUNDS(mx, my)) {
...
void CColorPicker::AddColor(char *colorName, BYTE *color)
{
...
void CColorPicker::CreateNewEntry(char *colorName, BYTE *bColor, float *fColor)
{
	...
	strcpy_s(colorText[numColors], strlen(colorName)+1, colorName);
