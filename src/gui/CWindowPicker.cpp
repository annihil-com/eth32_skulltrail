...
: CWindow(wlabel, wx, wy, ww, wh)
{
    ...
    buttons[CAT_AIMBOT2] = new CWindowButton("Aimbot Extras", 5, 5, 100, 13, CAT_AIMBOT2, this);
	buttons[CAT_VISUAL] = new CWindowButton("Visuals", 5, 5, 100, 13, CAT_VISUAL, this);
	buttons[CAT_VISUAL2] = new CWindowButton("Visuals Extras", 5, 5, 100, 13, CAT_VISUAL2, this);
	buttons[CAT_COLOR] = new CWindowButton("Color Picker", 5, 5, 100, 13, CAT_COLOR, this);
