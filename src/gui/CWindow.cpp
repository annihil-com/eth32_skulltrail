...
int CWindow::ProcessMouse(int mx, int my, UINT mevent, CControl **mhook, CControl **khook)
{
...
{
	sprintf_s(s, s_s, "%i %i %i %i", x, y, w, h);
	return s;
}
...
void CWindow::SetProps(const char *props, float xScale, float yScale)
{
	...
	sscanf_s(props, "%i %i %i %i", &px, &py, &pw, &ph);
