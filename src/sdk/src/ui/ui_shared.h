...
typedef rectDef_t sdkRectangle;

// FIXME: do something to separate text vs window stuff
typedef struct {
	sdkRectangle rect;					// client coord sdkRectangle
	sdkRectangle rectClient;			// screen coord sdkRectangle
	const char *name;				//
	const char *model;				//
	...
	sdkRectangle rectEffects;			// for various effects
	sdkRectangle rectEffects2;			// for various effects
...
typedef struct itemDef_s {
	...
	sdkRectangle textRect;				// sdkRectangle the text ( if any ) consumes     
